...
# Chapter 9: Review Questions - Attempt 5
...
* **A**❌❌❌❌
* **CORRECT ANSWER: F**
* Should use `Paths.get()` and relativize needs to be passed Path not String
<br>
...
### My answer:
* path is relative
* Itt will throw an exception at runtime since the files do not exist
* **F**✅✅✅✅
<hr>
...
### My answer:
* A - false, the `REPLACE_EXISTING` option is not specified
* B - true
* C - true
* D - false
* E - true
* **B,C,E**❌❌❌❌
* **CORRECT ANSWER: C,E**
* `NO_FOLLOWLINKS` is provided, so B is false
<br>
...
* C is not relevant to this question which is asking why use NIO.2's `readAttributes()` method over individual attributes like `Files.isDirectory()`
<br>
