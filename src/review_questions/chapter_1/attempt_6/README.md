# Chapter 1 - Review Questions Attempt 6
...
### My Answer:
* I don't think the code compiles but idk why
* **A**❌❌❌❌
* **CORRECT ANSWER: B**
...
* `r instance of Chipmunk` does not compile but I do not know why
* **F**❌❌❌❌
* **CORRECT ANSWER: E**
* Sinxed Runnable is an interface, the instanceof operator doesn't care
* ArrayList is a concrete class and this tells Java that it can not be an instance!
<hr>
...
* I think a semi colon is needed on line 3
...
### My Answer:
* enum does not compile since all elements do not implement abstract method
* **G**✅✅✅✅
<hr>
...
### My Answer:
* Strings are not overidden
* So it will print walk toddle
* **C**✅✅✅✅
<hr>
