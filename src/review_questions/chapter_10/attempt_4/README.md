...
# Chapter 10: Review Questions - Attempt 4
...
* **B**❌❌❌❌
* **CORRECT ANSWER: E**
* Connection can not be instantiated, it must be called statically from DriverManager
<br>
...
### My Answer:
* It's execute, executeUpdate, executeQuery
* **B**✅✅✅✅
<br>
...
### My Answer:
* It's ResultSet, Statement Connection
* **D**✅✅✅✅
<br>
...
### My Answer:
* Cannot call `previous` on ResultSet
* **E**✅✅✅✅
<br>
...
### My Answer:
* **E**
* can not call absolute on forward only connection❌❌❌❌
* **CORRECT ANSWER: A**
<br>
